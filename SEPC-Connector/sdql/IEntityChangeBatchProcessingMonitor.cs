...
// Type: com.oddsmatrix.sepc.connector.sdql.IEntityChangeBatchProcessingMonitor
...
{
  public interface IEntityChangeBatchProcessingMonitor
  {
    string GetLastAppliedEntityChangeBatchUuid();
  }
}
