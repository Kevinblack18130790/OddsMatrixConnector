...
// Type: com.oddsmatrix.sepc.connector.sportsmodel.EventPartDefaultUsage
...
{
  public class EventPartDefaultUsage : Entity, IXmlSerializable
  {
    ...
    public void ReadXml(XmlReader reader)
    {
      ...
      if (reader.GetAttribute("parentEventId") != null)
        this.parentEventId = new long?(XmlConvert.ToInt64(reader.GetAttribute("parentEventId")));
      if (reader.GetAttribute("eventTypeId") != null)
        this.eventTypeId = new long?(XmlConvert.ToInt64(reader.GetAttribute("eventTypeId")));
      if (reader.GetAttribute("sportId") != null)
        this.sportId = new long?(XmlConvert.ToInt64(reader.GetAttribute("sportId")));
