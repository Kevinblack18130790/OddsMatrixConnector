...
// Type: com.oddsmatrix.sepc.connector.sportsmodel.StreamingProvider
...
{
  public class StreamingProvider : Entity, IXmlSerializable
  {
    ...
    public void ReadXml(XmlReader reader)
    {
      ...
      this.urlTemplate = reader.GetAttribute("urlTemplate");
    }
