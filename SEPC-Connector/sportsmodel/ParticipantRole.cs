...
// Type: com.oddsmatrix.sepc.connector.sportsmodel.ParticipantRole
...
{
  public class ParticipantRole : Entity, IXmlSerializable
  {
    ...
    public void ReadXml(XmlReader reader)
    {
      ...
      this.isPrimary = XmlConvert.ToBoolean(reader.GetAttribute("isPrimary"));
    }
