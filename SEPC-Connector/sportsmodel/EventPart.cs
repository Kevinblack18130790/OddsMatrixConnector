...
// Type: com.oddsmatrix.sepc.connector.sportsmodel.EventPart
...
{
  public class EventPart : Entity, IXmlSerializable
  {
    ...
    public void ReadXml(XmlReader reader)
    {
      ...
      this.orderNum = XmlConvert.ToInt32(reader.GetAttribute("orderNum"));
      if (reader.GetAttribute("isDrawPossible") == null)
        return;
      this.isDrawPossible = new bool?(XmlConvert.ToBoolean(reader.GetAttribute("isDrawPossible")));
    }
