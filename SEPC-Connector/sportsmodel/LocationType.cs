...
// Type: com.oddsmatrix.sepc.connector.sportsmodel.LocationType
...
{
  public class LocationType : Entity, IXmlSerializable
  {
    ...
    public void ReadXml(XmlReader reader)
    {
      ...
      if (reader.GetAttribute("hasCode") != null)
        this.hasCode = new bool?(XmlConvert.ToBoolean(reader.GetAttribute("hasCode")));
      this.codeDescription = reader.GetAttribute("codeDescription");
    }
