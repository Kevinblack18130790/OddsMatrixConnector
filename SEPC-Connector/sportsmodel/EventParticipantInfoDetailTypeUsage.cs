...
// Type: com.oddsmatrix.sepc.connector.sportsmodel.EventParticipantInfoDetailTypeUsage
...
{
  public class EventParticipantInfoDetailTypeUsage : Entity, IXmlSerializable
  {
    public long id { get; set; }

    public int version { get; set; }

    public long eventParticipantInfoDetailTypeId { get; set; }
    ...
    public void ReadXml(XmlReader reader)
    {
      ...
      this.eventParticipantInfoDetailTypeId = XmlConvert.ToInt64(reader.GetAttribute("eventParticipantInfoDetailTypeId"));
