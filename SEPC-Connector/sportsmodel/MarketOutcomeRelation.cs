...
// Type: com.oddsmatrix.sepc.connector.sportsmodel.MarketOutcomeRelation
...
{
  public class MarketOutcomeRelation : Entity, IXmlSerializable
  {
    ...
    public void ReadXml(XmlReader reader)
    {
      ...
      this.marketId = XmlConvert.ToInt64(reader.GetAttribute("marketId"));
