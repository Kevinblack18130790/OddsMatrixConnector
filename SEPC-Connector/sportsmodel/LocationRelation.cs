...
// Type: com.oddsmatrix.sepc.connector.sportsmodel.LocationRelation
...
{
  public class LocationRelation : Entity, IXmlSerializable
  {
    ...
    public void ReadXml(XmlReader reader)
    {
      ...
      this.fromLocationId = XmlConvert.ToInt64(reader.GetAttribute("fromLocationId"));
      this.toLocationId = XmlConvert.ToInt64(reader.GetAttribute("toLocationId"));
    }
